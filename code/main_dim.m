...
Traj_ref0 = x_Lyap{50};      % Reference Trajectory (pos/vel)
...
SB0 = SB_ref;
R0 = Traj_ref0(1,1:3)'* Var.lstar;         % In S frame
nu0 = Traj_ref0(1,4:6)'*Var.lstar/Var.tstar;        % In S frame
...
SB0 = SB_ref;
R0 = Traj_ref(1,1:3)'* Var.lstar;            % In N frame; with SB0 = eye(3), it is the same in B frame.
nu0 = Traj_ref(1,4:6)'* Var.lstar/Var.tstar; % In N frame
