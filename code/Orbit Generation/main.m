...
%% Obtain Collinear Lagrange Points

[Var.L1x, Var.L2x, Var.L3x] = CollinearLagrangePointx(Var.mu);

%% L1
%% Lyapunov Orbit
q0 = [0.8234 0 0 0.1263 0 0.1263 0]'; %% ds negative
STM0 = eye(length(q0));


%% Northern Halo Orbit
q0 = [0.8234 0 0.0224 0 0.1343 0]'; %% ds positive
...
%% Northest Axial Orbit
%q0 = [0.7824] % positive ds and positive ydot
